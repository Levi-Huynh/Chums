                ...
                for (var j = 0; j < filteredServices.length; j++) {
                    ...
                    for (var k = 0; k < filteredTimes.length; k++) {
                        ...
                        for (var l = 0; l < filteredGroupServiceTimes.length; l++) {
                            ...
                            rows.push(<tr><td>{props.importData.campuses[i].name}</td><td>{props.importData.services[j].name}</td><td>{props.importData.serviceTimes[k].name}</td><td>{group.categoryName}</td><td>{group.name}</td><td>{getMemberCount(group.importKey)}</td></tr>);
                        }
                    }
                }
            }
